...
echo "<script language='JavaScript' src='js/pagehighlights.js' type='text/javascript'></script>"; 
...
class TwitterProxy {
	 ...
	 */
	public function __construct($oauth_access_token, $oauth_access_token_secret, $consumer_key, $consumer_secret, $user_id, $screen_name, $count = 100) {
		$this->config = array_merge($this->config, compact('oauth_access_token', 'oauth_access_token_secret', 'consumer_key', 'consumer_secret', 'count'));
	...
	public function get($url) {
		...
		// get keywords to pass to search API
